...
public class Auth {
    ...
    public void digest_authentication() {
        ...
        given()
               ...
               //.auth().basic("postman", "password")
                .auth().digest("postman","password")   //Passing the username and password
                .when()
                .get()
                .then()
                .log().all()
    ...
    /*
     * oAuth 1.0: Is a kind of authentication used to work on our-behalf by allowing the 3rd party app
     *
   ...
   /* @Test
    public void paypal_test() {
        ...
        given()
                ...
                .basePath("/v2/invoicing/generate-next-invoice-number")
